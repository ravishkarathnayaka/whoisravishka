  ...
  const handleQuerySubmit = (e?: React.FormEvent, customPrompt?: string) => {
    ...
    setTimeout(() => {
      ...
      if (lower.startsWith('/help')) {
        ...
        reply = "Key documented builds include:\n1. Zero Trust Network Access (ZTNA) & Identity-Aware Gateway (NIST SP 800-207)\n2. Automated Active Directory Attack & Detection Range (Purple Teaming)\n3. eBPF Linux Runtime Threat Detection & EDR Agent (<1.2% CPU)\n4. Enterprise Software Supply Chain Security (SLSA Level 3)\n5. Multi-Cloud Automated Threat Detection & SOAR Pipeline\n6. TrialReady LK AI-Assisted Driving Academy Management\n7. UniFlow Student Productivity Hub (Azure)\n8. Real-Time Encrypted Chat Room (Python WebSockets)";
