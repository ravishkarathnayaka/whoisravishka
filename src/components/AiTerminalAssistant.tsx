  ...
  const handleQuerySubmit = (e?: React.FormEvent, customPrompt?: string) => {
    ...
    setTimeout(() => {
      ...
      if (lower.startsWith('/help')) {
        ...
        reply = "Key documented builds include:\n1. Automated Threat Intelligence Aggregator & Feed Scoring Engine\n2. Zero Trust Network Access (ZTNA) & Identity-Aware Gateway (NIST SP 800-207)\n3. Automated Active Directory Attack & Detection Range (Purple Teaming)\n4. eBPF Linux Runtime Threat Detection & EDR Agent (<1.2% CPU)\n5. Enterprise Software Supply Chain Security (SLSA Level 3)\n6. Multi-Cloud Automated Threat Detection & SOAR Pipeline\n7. TrialReady LK AI-Assisted Driving Academy Management\n8. UniFlow Student Productivity Hub (Azure)\n9. Real-Time Encrypted Chat Room (Python WebSockets)";
