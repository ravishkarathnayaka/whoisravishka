  ...
  const handleQuerySubmit = (e?: React.FormEvent, customPrompt?: string) => {
    ...
    setTimeout(() => {
      ...
      if (lower.startsWith('/help')) {
        ...
        reply = "Key documented builds include:\n1. Kubernetes Runtime Security & Cloud-Native Incident Response Platform (Falco eBPF)\n2. Automated Threat Intelligence Aggregator & Feed Scoring Engine\n3. Zero Trust Network Access (ZTNA) & Identity-Aware Gateway (NIST SP 800-207)\n4. Automated Active Directory Attack & Detection Range (Purple Teaming)\n5. eBPF Linux Runtime Threat Detection & EDR Agent (<1.2% CPU)\n6. Enterprise Software Supply Chain Security (SLSA Level 3)\n7. Multi-Cloud Automated Threat Detection & SOAR Pipeline\n8. TrialReady LK AI-Assisted Driving Academy Management\n9. UniFlow Student Productivity Hub (Azure)\n10. Real-Time Encrypted Chat Room (Python WebSockets)";
