  ...
  const handleQuerySubmit = (e?: React.FormEvent, customPrompt?: string) => {
    ...
    setTimeout(() => {
      ...
      if (lower.startsWith('/help')) {
        ...
        reply = "Key documented builds include:\n1. Automated Active Directory Attack & Detection Range (Purple Teaming)\n2. eBPF Linux Runtime Threat Detection & EDR Agent (<1.2% CPU)\n3. Enterprise Software Supply Chain Security (SLSA Level 3)\n4. Multi-Cloud Automated Threat Detection & SOAR Pipeline\n5. TrialReady LK AI-Assisted Driving Academy Management\n6. UniFlow Student Productivity Hub (Azure)\n7. Real-Time Encrypted Chat Room (Python WebSockets)";
